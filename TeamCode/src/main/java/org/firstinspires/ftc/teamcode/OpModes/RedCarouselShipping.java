    ...
    public void runOpMode() throws InterruptedException {
        ...
        switch (vision.senseRedCarousel(this)) {
            case 1:
                ...
                dt.turnPID(90, true, .7/90, .028, .02/90, 2);
                dt.encoderMove(.6, 19.5, 3);
                dt.turnPID(90, true, .7/90, .029, .02/90, 2);
